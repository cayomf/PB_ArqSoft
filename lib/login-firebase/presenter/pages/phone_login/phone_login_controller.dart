...
@Injectable()
class PhoneLoginController = _PhoneLoginControllerBase with _$PhoneLoginController;
...
abstract class _PhoneLoginControllerBase with Store {
  ...
  _PhoneLoginControllerBase(this.loginWithPhoneUsecase, this.loading, this.authStore);

  @observable
  String phone = "";

  @computed
  LoginCredential get credential => LoginCredential.withPhone(phoneNumber: phone);
